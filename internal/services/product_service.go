...
func (s *ProductService) GetProduct(id uint) (*dto.ProductResponse, error) {
	...
	response := s.convertToProductResopnse(&product)
	return &response, nil
}
...
func (s *ProductService) GetProducts(page, limit int) ([]dto.ProductResponse, *utils.PaginationMeta, error) {
	...
	for i := range products {
		response[i] = s.convertToProductResopnse(&products[i])
	}
...
func (s *ProductService) convertToProductResopnse(product *models.Product) dto.ProductResponse {
